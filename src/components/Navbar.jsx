...
const Navbar = () => {
  ...
  return (
    <div className="max-w-5xl flex justify-between mx-auto items-center h-24 p-5">
      {/* Logo */}
      ...
      <div className="py-7">
        <ul className="md:flex hidden">
          <li className="px-5 hover:text-[#e9ab53] hover:transition cursor-pointer duration-500">Home</li>
          <li className="px-5 hover:text-[#e9ab53] hover:transition cursor-pointer duration-500">New</li>
          <li className="px-5 hover:text-[#e9ab53] hover:transition cursor-pointer duration-500">Popular</li>
          <li className="px-5 hover:text-[#e9ab53] hover:transition cursor-pointer duration-500">Trending</li>
          <li className="pl-5 hover:text-[#e9ab53] hover:transition cursor-pointer duration-500">Categories</li>
        </ul>
      </div>
      ...
      <ul className="py-[10%] mt-20 text-2xl font-writing font-medium">
          ...
          <li className="mb-6 py-2 cursor-pointer hover:text-[#e9ab53] hover:transition">New</li>
          <li className="mb-6 py-2 cursor-pointer hover:text-[#e9ab53] hover:transition">Popular</li>
          <li className="mb-6 py-2 cursor-pointer hover:text-[#e9ab53] hover:transition">Trending</li>
